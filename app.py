...
print("🚀 Ultra-lightweight mode enabled - Manual joint setting only")
print("📦 AI dependencies completely removed for fast deployment")
...
@app.route('/')
def index():
    return render_template('index.html', manual_only=True, ai_available=False)
    ...
    if file and allowed_file(file.filename):
        try:
            ...
            return jsonify({
                ...
                'detection_method': 'Manual positioning (ultra-lightweight mode)',
                'dependencies_available': False,
                'manual_mode_only': True
            })
    ...
    try:
        ...
        return jsonify({
            ...
            'deployment_info': {
                ...
                'app_mode': 'Ultra-lightweight manual mode'
            }
        })
...
def health_check():
    ...
    status_info = {
        ...
        'features': {
            ...
            'ai_pose_detection': False,    # 完全無効
            'angle_analysis': True         # Python基本計算で常に利用可能
        },
        'message': 'Ultra-lightweight mode - Manual functionality only'
    }
